...
public:
    ...
    void readAscii(FILE* fp) {
        PS::S32 Flag;
        if ( !fscanf(fp, "%lld%lf%lf%lf%lf%lf%lf%lf%lf%lf%d%d%lf",
                     &this->id, &this->mass, &this->r_planet, &this->f, 
                     &this->pos.x, &this->pos.y, &this->pos.z,
                     &this->vel.x, &this->vel.y, &this->vel.z,
                     &this->neighbor, &Flag, &this->eps) ) {
...
#endif
        if ( !fprintf(fp, "%lld\t%20.15e\t%20.15e\t%20.15e\t%20.15e\t%20.15e\t%20.15e\t%20.15e\t%20.15e\t%20.15e\t%d\t%d\t%20.15e\n",
                      this->id, this->mass, this->r_planet, this->f, 
                      this->pos.x, this->pos.y, this->pos.z,
                      this->vel.x, this->vel.y, this->vel.z,
                      this->neighbor, Flag, this->eps) ) {
